...
| **US-7** | 🚧 | As the owner, a **trip detail page** lets me relive a trip. | Shows the track on an OSM map, an elevation profile, and a photo gallery with map markers. *(Map + elevation done; the photo gallery lands with the photo stories US-2…US-5.)* |
